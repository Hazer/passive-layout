...
public class PassiveLinearLayout extends LinearLayout {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams implements PassiveLayoutParams {
    ...
    public PassiveLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public PassiveLinearLayout(Context context, AttributeSet attrs, int defStyle) {
